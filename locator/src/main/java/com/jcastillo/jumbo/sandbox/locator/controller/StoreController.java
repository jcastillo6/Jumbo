...
public class StoreController {
    ...
    @ApiResponses(value = { @ApiResponse(responseCode =  "200", description = "List of stores, with the distance between the point and the store"),
	...
	@ResponseBody
    @ApiOperation("Create a list of store in the app")
    @ApiResponses(value = { @ApiResponse(responseCode =  "201", description = "return the list of the stores that was successfully created"),
    		@ApiResponse(responseCode =  "400", description = "Bad request parameter, the service can return a message in the body with the "
    ...
    @ApiResponses(value = { @ApiResponse(responseCode =  "200", description = "return the store"),
    		@ApiResponse(responseCode =  "400", description = "Bad request parameter, the service can return a message in the body with the "
    				+ "following information: {errorCode: 2004, message: Invalid store Id}"),@ApiResponse(responseCode =  "404", description = "Store not found")})
